...
<div class="container">
    <div class="row py-5 bumper my-auto align-items-center">
      <div class="col-md-8 col-12 p-4 bglight">
        ...
        <h5 class="btnexplore mt-5 pointer fww">Explore Now <i class="fa-regular fa-circle-right btnexplore"></i></h5>
      </div>
      <div class="imgabsolute3"></div>
    </div>
  </div>
  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col-md-5 col-12">
        <button type="button" class="col-12 my-1 text-left btn btn-success"><i class="far fa-calendar mr-2"> </i> Guided trip with our expert agent</button>
        <button type="button" class="col-12 my-1 text-left btn btn-success"><i class="fas fa-users mr-2"> </i> Meet another travelers</button>
        <button type="button" class="col-12 my-1 text-left btn btn-success"><i class="fas fa-gopuram mr-2"> </i> More than one destination</button>
      </div>
      <div class="col-md-7 col-12 px-5">
        <p class="justifytext">
          Our open trips are designed to take the stress out of travel planning, while still allowing for plenty of flexibility and spontaneity. You'll have the opportunity to explore the local culture, indulge in delicious cuisine, and
          embark on exciting outdoor activities - all while making new friends and creating unforgettable memories.
        </p>
      </div>
    </div>
